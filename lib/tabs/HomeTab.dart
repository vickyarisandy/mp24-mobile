...
List<Map> categories = [
  ...
  {'icon': Icons.local_hospital, 'text': 'Rumah Sakit'},
  {'icon': Icons.car_rental, 'text': 'Antar'},
  {'icon': Icons.local_pharmacy, 'text': 'Obat'},
];
          ...
          Expanded(
            child: TextField(
              decoration: InputDecoration(
                ...
                hintText: 'Pencarian Tips dan Trik Kesehatan',
                hintStyle: TextStyle(
                    fontSize: 13,
